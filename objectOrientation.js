...
favoriteThings['show'] = 'Cirque du Soleil';
...
console.log(greeting({title: 'mr', firstName: 'joe', lastName: 'schmoe'}));
...
console.log(totalPopulation({utah: 4, california: 1, texas: 3, arizona: 2}));
...
console.log(ingredients({carb: 'potatoes', fat: 'olive oil', protein: 'meat'}));
...
const cat = new Cat ('Bandit', 5, 'tuxedo')
...
const wizard = new Wizard('Jazz', 17, 'poof away');
wizard.castSpell();
...
// const phone = new Phone('Samsung', 'Galaxy', 128, 'green', 400);
// phone.changePrice(200);
// console.log(phone);
...
let phone1 = new Phone('Samsung', 'SE20', 64, 'green', 300);
let phone2 = new Phone('Apple', 'SE', 64, 'yellow', 500);
let phone3 = new Phone('Google', 'Pixel', 128, 'black', 600);
...
let myFirstVehicle = new Vehicle(5, 'orange', 75000)
...
const myFirstBoat = new Boat(5, 'white', 7000, 'Darling', 'fishing boat', false);
